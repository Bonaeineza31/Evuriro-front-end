...
const Dhospital = () => {
  ...
  // Sample data for Rwandan hospitals
  const hospitals = [
    {
      id: 1,
    ...
    },
    {
      ...
      distance: 7.2,
      address: "Butaro, Burera District, Northern Province",
      phone: "+250 788 350 115",
      specialties: ["Cardiology", "Pulmonology", "Oncology"],
      bedAvailability: 5,
      emergencyServices: true,
      rating: 4.8,
      waitTime: "35 min",
    ...
    },
    {
      ...
      distance: 1.8,
      address: "KG 28 Ave, Gasabo, Kigali",
      phone: "+250 788 513 684",
  ...
  return (
    <div className="hospital-container">
      <div className="hospital-header">
        <h1>Rwanda Hospital Directory</h1>
      ...
      <div className="hospital-nav">
        ...
        <button className={`nav-btn ${activeView === "beds" ? "active" : ""}`} onClick={() => setActiveView("beds")}>
        ...
        <div className="modal-overlay">
          <div className="modal-container modal-large">
            <div className="modal-header">
              ...
              <button className="modal-close" onClick={() => setShowHospitalDetails(false)}>
                ×
              </button>
            </div>
            <div className="modal-body">
                ...
                <div className="hospital-details-section">
                  ...
                  <div className="specialty-tags">
                    {selectedHospital.specialties.map((specialty, index) => (
                      <span key={index} className="specialty-detail-tag">
                        {specialty}
                      </span>
                    ))}
                  </div>
            ...
            <div className="modal-footer">
              <button className="btn-secondary" onClick={() => setShowHospitalDetails(false)}>
                Close
              </button>
              <button
