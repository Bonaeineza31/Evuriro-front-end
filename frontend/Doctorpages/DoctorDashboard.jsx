...
const DoctorDashboard = () => {
  ...
  const [doctorName, setDoctorName] = useState("Dr. Mugisha")
  ...
  const upcomingAppointments = [
    ...
    { id: 2, time: "11:30 AM", patient: "Uwase Claudine", reason: "Consultation", isVideo: false },
    { id: 3, time: "1:15 PM", patient: "Nshimiyimana Eric", reason: "Test Results", isVideo: true },
    { id: 4, time: "2:45 PM", patient: "Mukamana Diane", reason: "First Visit", isVideo: false },
    { id: 5, time: "4:00 PM", patient: "Ndayishimiye Jean", reason: "Prescription Renewal", isVideo: false },
  ]

  // Sample waiting patients
  const waitingPatients = [
    { id: 1, name: "Umutoni Alice", waiting: "15 mins", priority: "Normal" },
    { id: 2, name: "Hakizimana James", waiting: "8 mins", priority: "Urgent" },
    { id: 3, name: "Uwimana Keza", waiting: "5 mins", priority: "Normal" },
    { id: 4, name: "Mugabo David", waiting: "Just arrived", priority: "Normal" },
    { id: 5, name: "Uwineza Susan", waiting: "20 mins", priority: "Priority" },
  ]
      ...
      <div className="dashboard-content2">
        ...
        <div className="welcome-banner">
          ...
          <div className="doctor-info">
            <img src={Smith || "/placeholder.svg"} alt="Doctor profile" className="doctor-avatar" />
            <div>
        ...
        <div className="quick-actions2">
          ...
          <div className="action-buttons2">
            ...
            >
              ...
              {activeTooltip === "newPatient" && <div className="tooltip">Add a new patient to the system</div>}
            </button>
            ...
            >
              ...
              {activeTooltip === "prescription" && <div className="tooltip">Create and send a new prescription</div>}
            </button>
            ...
            >
              <LabOrderIcon />
              Create Lab Order
              {activeTooltip === "labOrder" && <div className="tooltip">Order laboratory tests for patients</div>}
            </button>
            ...
            >
              <StatisticsIcon />
              View Statistics
              {activeTooltip === "statistics" && <div className="tooltip">View practice statistics and reports</div>}
            </button>
          </div>
        </div>
      </div>
              ...
              <form onSubmit={handlePrescriptionSubmit}>
                <div className="form-group">
                  ...
                  >
                    ...
                    {upcomingAppointments.map((appt) => (
                      <option key={appt.id} value={appt.patient}>
                        {appt.patient}
                      </option>
                    ))}
                  </select>
